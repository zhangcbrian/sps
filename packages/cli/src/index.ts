...
program
  .name("sps")
  .description(
    "sps — turn natural language requirements into structured, traceable specs in git"
  )
  .version("0.3.0");
...
program
  .command("init")
  .description(
    "Initialize sps in the current repo. With --ci=github, writes .github/workflows/sps.yml. With --ci=husky, writes .husky/pre-push."
  )
